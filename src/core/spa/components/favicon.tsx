...
export default ({ favicons = [], backgroundColor = '#FFFFFF' }: IFavicons) => {
  return (
    <>
      {favicons.indexOf('apple-touch-icon-57x57.png') > -1 && (
        <link
      ...
      {favicons.indexOf('apple-touch-icon-114x114.png') > -1 && (
        <link
          rel="apple-touch-icon-precomposed"
          sizes="114x114"
      ...
      {favicons.indexOf('apple-touch-icon-72x72.png') > -1 && (
        <link
          rel="apple-touch-icon-precomposed"
          sizes="72x72"
      ...
      {favicons.indexOf('apple-touch-icon-144x144.png') > -1 && (
        <link
          rel="apple-touch-icon-precomposed"
          sizes="144x144"
      ...
      {favicons.indexOf('apple-touch-icon-60x60.png') > -1 && (
        <link
          rel="apple-touch-icon-precomposed"
          sizes="60x60"
      ...
      {favicons.indexOf('apple-touch-icon-120x120.png') > -1 && (
        <link
          rel="apple-touch-icon-precomposed"
          sizes="120x120"
      ...
      {favicons.indexOf('apple-touch-icon-76x76.png') > -1 && (
        <link
          rel="apple-touch-icon-precomposed"
          sizes="76x76"
      ...
      {favicons.indexOf('apple-touch-icon-152x152.png') > -1 && (
        <link
          rel="apple-touch-icon-precomposed"
          sizes="152x152"
      ...
      {favicons.indexOf('favicon-196x196.png') > -1 && (
        <link
          rel="icon"
          type="image/png"
      ...
      {favicons.indexOf('favicon-96x96.png') > -1 && (
        <link
          rel="icon"
          type="image/png"
      ...
      {favicons.indexOf('favicon-32x32.png') > -1 && (
        <link
          rel="icon"
          type="image/png"
      ...
      {favicons.indexOf('favicon-16x16.png') > -1 && (
        <link
          rel="icon"
          type="image/png"
      ...
      {favicons.indexOf('favicon-128.png') > -1 && (
        <link
          rel="icon"
          type="image/png"
      ...
      {favicons.indexOf('mstile-144x144.png') > -1 && (
      ...
      {favicons.indexOf('mstile-70x70.png') > -1 && (
        <meta
          name="msapplication-square70x70logo"
          content="/assets/favicons/mstile-70x70.png"
        />
      )}
      {favicons.indexOf('mstile-150x150.png') > -1 && (
        <meta
          name="msapplication-square150x150logo"
          content="/assets/favicons/mstile-150x150.png"
        />
      )}
      {favicons.indexOf('mstile-310x150.png') > -1 && (
        <meta
          name="msapplication-wide310x150logo"
          content="/assets/favicons/mstile-310x150.png"
        />
      )}
      {favicons.indexOf('mstile-310x310.png') > -1 && (
        <meta
